...
>   Widget负责配置数据结构，轻量级，Widget持有着RenderObject，Widget可以创建RenderObject(widget的变种类RenderObjectWidget);Widget 本身有 createElement 的抽象方法用于创建 Element 对象；RenderObjectWidget 组件会额外承担 createRenderObject 任务来创建渲染对象; <br/>
