...
Page({
    ...
    onPublishAdvertisement: function () {
        ...
        if (this.data.moment.Guid) {
            webapi.PublishAdvertisement({
                PublishStoreGuid: Request.getStoreGuid(),
                DisplayStoreGuid: '',
                DisplayItemGuid: this.data.moment.Guid,
                Description: this.data.moment.Advertisement.Description,
                DisplayType: 1,
                Status: 1,
                BidPrice: 1
            })
