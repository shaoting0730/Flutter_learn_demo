...
class Utils {
  ...
  static DateTime fromAspDateTimeTicks(int ticks) {
    var epochTicks =
        621355968000000000; // the number of .net ticks at the unix epoch
    var ticksPerMillisecond =
        10000; // there are 10000 .net ticks per millisecond

    //date is ticks, converted to microtime, minus difference from epoch microtime
    return DateTime.fromMillisecondsSinceEpoch(
        (ticks - epochTicks) ~/ ticksPerMillisecond,
        isUtc: true);
  }
...
//    MoneyUnit moneyUnit = MoneyUnit.NORMAL;
//    String str = '123.00';
//    num value = NumUtil.getNumByValueStr(str, fractionDigits: 2);
//    print(value);
//
//    String piAsString = 123.0053.toStringAsFixed(2);
//    print(piAsString);
...
class MyTheme {
  ...
  static const text12BgGrey =
      TextStyle(backgroundColor: Color(0xFFE0E0E0), fontSize: 12);
  static const text12LineThrough = TextStyle(
