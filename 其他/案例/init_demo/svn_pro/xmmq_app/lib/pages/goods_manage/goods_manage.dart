...
import '../../widgets/search_filter_pane2.dart';
...
class GoodsManage extends StatefulWidget {
  @override
  State<GoodsManage> createState() {
    return GoodsManageState();
  }
}

class GoodsManageState extends State<GoodsManage>
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Image.asset(
                                  'assets/icon_goods_release_white.png'),
                              Text(
                                '发布动态',
                                style: TextStyle(
                                  color: Colors.white,
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: <Widget>[
                              Image.asset('assets/icon_goods_delete_white.png'),
                              Text(
                                '批量下架',
                                style: TextStyle(
                                  color: Colors.white,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      InkWell(
                        ...
                        child: Image.asset(
                          'assets/icon_publish_photo_yellow.png',
                          width: 50,
                          height: 50,
                          fit: BoxFit.fill,
                        ),
...
//                价格
          ...
          Positioned(
            top: 5.0,
            right: 5.0,
            child: widget.selectTag == true
                ? _currentSelectTag == false
