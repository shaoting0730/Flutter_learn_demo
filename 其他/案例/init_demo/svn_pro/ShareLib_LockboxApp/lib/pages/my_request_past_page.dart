...
class MyExpiredShowingRequestPage extends BasePage {
  @override
  State<StatefulWidget> createState() {
    return MyExpiredShowingRequestPageState();
  }
}

class MyExpiredShowingRequestPageState extends BasePageState {
  ...
  void initState() {
    super.initState();
    title = "Expired Showing Request";
    _searchRequest = ShowingScheduleSearch(StartCreateTime: 0, EndCreateTime: DateTimeToTicks(DateTime.now().toUtc()), PageIndex: 0, PageSize: 50, RequestStatus: 0);
