...
class PowerSteeringWidget extends StatefulWidget {
  final void Function(Offset) onChange;

  const PowerSteeringWidget({Key? key, required this.onChange}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return PowerSteeringWidgetState();
  }
}

class PowerSteeringWidgetState extends State<PowerSteeringWidget> {
  //偏移量
