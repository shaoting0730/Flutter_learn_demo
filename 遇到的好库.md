...
> [ 一种响应式自动管理state: signal ]( https://pub.dev/packages/signal ) <br/>
...
> [ 内阴影flutter_inset_shadow ](  https://pub.dev/packages/flutter_inset_shadow ) <br/>
...
> [ 版本更新 ]( https://github.com/axions-org/in_app_update_flutter ) <br/>
...
> [瀑布流: flexbox_layout]( https://pub.dev/packages/flexbox_layout )  <br/>

> [瀑布流: waterfall_flow]( https://pub.dev/packages/waterfall_flow )  <br/>
...
> [ 获取手机文件  ]( https://pub.dev/packages/file_picker )    <br/>
...
> [ 流程引导1 flutter_intro  ]( https://github.com/tal-tech/flutter_intro )    <br/>

> [ 流程引导2 tutorial_coach_mark ]( https://github.com/RafaelBarbosatec/tutorial_coach_mark )    <br/>

> [ 流程引导3 feature_discovery ]( https://pub.dev/packages/feature_discovery )    <br/>

> [ 流程引导4 showcaseview ]( https://pub.dev/packages/showcaseview )    <br/>
...
> [ 用svga 写动画 ]( https://pub.dev/packages/flutter_svga )    <br/>
...
> [ 防抖 ]( https://pub.dev/packages/function_filter ) 或者 [ 防多次误触 ]( https://github.com/shaoting0730/Flutter_learn_demo/blob/master/%E5%85%B6%E4%BB%96/%E6%A1%88%E4%BE%8B/%E4%B8%80%E4%BA%9B%E5%B0%8F%E7%8E%A9%E6%84%8F/widget/tap_el.dart ) 或者 [stream_transform](https://pub.dev/packages/stream_transform)   <br/>
...
> [ 聚焦或者失焦的反馈 focus_detector_v2  ]( https://pub.dev/packages/focus_detector_v2  )    <br/>
...
> [ 即构直播 https://console.zego.im/  ]( https://console.zego.im/ )    <br/>

> [ 日历 table_calendar  ]( https://pub-web.flutter-io.cn/packages/table_calendar )    <br/>

> [  数学运算  ]( https://pub.dev/packages/math_expressions )    <br/>

> [  sliver工具扩展包  ]( https://pub.dev/packages/sliver_tools )    <br/>

> [  pip 画中画  ]( https://github.com/opentraa/pip )    <br/>

> [ 内存溢出警告  ]( https://github.com/dart-lang/leak_tracker?tab=readme-ov-file  )    <br/>

> [ 和原生交互便捷库: flutter_native_bridge  ](  https://github.com/UttamPanchasara/flutter-native-bridge   )    <br/>

> [ android 设置手机桌面壁纸、锁屏壁纸 Wallpaper  ](  https://github.com/pratiktimer/setWallpaperplugin/tree/master  )    <br/>

> [ android 设置各种铃声  ](  https://pub.dev/packages/ringtone_set_plus  )    <br/>

> [ 渐变色border  ](  https://pub.dev/packages/gradient_borders/install  )    <br/>

> [ 广告插件1  ]( https://github.com/FlutterAds/flutter_pangle_ads  ) ---  [ 广告插件2  ]( https://github.com/gstory0404/flutter_unionad  )   <br/>

> [ 专业级五线谱排版引擎  flutter_notemus ](  https://pub.dev/packages/flutter_notemus  )    <br/>

> [ 让你知道你当前的位置的scrollbar  section_scrollbar ](  https://pub.dev/packages/section_scrollbar )    <br/>

> [ 多窗口panes:仪表盘或者桌面端应用 ](  https://github.com/SoFluffyOS/panes )    <br/>

> 社会化分享 [ wechat_kit ](  https://pub.dev/packages/wechat_kit ) -- [ tencent_kit]( https://pub.dev/packages/tencent_kit ) -- [ weibo_kit](  https://pub.dev/packages/weibo_kit) --  [ 系统分享兜底 share_plus](  https://pub.dev/packages/share_plus )  <br/>

> [ 震动反馈1——haptic_feedback ](  https://github.com/nohli/haptic_feedback )  -- [ 震动反馈2——pulsar ]( https://github.com/software-mansion/pulsar  ) -- [ 震动反馈3——flutter_vibration ](  https://github.com/benjamindean/flutter_vibration )   <br/>

> [ 书本翻页效果book_page_flip ](  https://pub.dev/packages/book_page_flip )    <br/>

> [ 将音频转为震动反馈:haptify ](  https://github.com/imedboumalek/haptify )    <br/>
